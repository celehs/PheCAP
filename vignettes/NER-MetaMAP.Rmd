...
Run [MetaMap_postprocessing.R](https://github.com/celehs/PheCAP/blob/master/code/MetaMap_postprocessing.R) to extract the CUIs from the output and select by majority voting.
