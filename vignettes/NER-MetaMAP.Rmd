...
![](include/img/Screenshot_MetaMap_Website.png)
...
![](include/img/Screenshot_MetaMap_WikiOutput.png)

<br>

Run <a href="include/MetaMap_postprocessing.R" download>MetaMap_postprocessing.R</a> to extract the CUIs from the output and select by majority voting.
